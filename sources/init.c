...
void	init_game(t_game *game)
{
	...
	game->north_wall.width = w; game->north_wall.height = h;

	game->west_wall.img = mlx_xpm_file_to_image(game->mlx, "./textures/wall.xpm", &w, &h);
	...
	game->west_wall.width = w; game->west_wall.height = h;
	...
	game->south_wall.width = w; game->south_wall.height = h;
	...
	game->east_wall.width = w; game->east_wall.height = h;
